...
#Feature genration for the sites that are either gained or lost after differentitaion
bedtools intersect -a /Users/cmdb/qbb2021-answers/qbio_week5/Mus_musculus.GRCm38.94_features.bed -b gain_CTCF_binding.bed > peaks_gained_features.bed
bedtools intersect -a /Users/cmdb/qbb2021-answers/qbio_week5/Mus_musculus.GRCm38.94_features.bed -b loss_CTCF_binding.bed > peaks_lost_features.bed